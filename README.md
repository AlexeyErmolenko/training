...
for [training_start](https://crm.saritasa.com/projects/general.aspx?ProjectID=???) project
...
## API Documentation
https://apidocs.saritasa.io/?url=training_start/develop/training_start-latest.yaml

## Goolge Drive
TODO: setup link

## SonarQube
https://sonarqube.saritasa.com/dashboard?id=training_start-backend
...
```
mkdir training_start && cd training_start
git clone ssh://gitblit.saritasa.com/training_start/backend.git
cd backend
...
docker ps
```
There should be: training_start-web, training_start-db, training_start-redis
...
(*shortcut for ```docker inspect training_start-web | grep IPAddress```*) -
